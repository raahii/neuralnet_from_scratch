...
conv1 = Conv( activation_function = [Relu(), LRN(), Pooling(3, 3), Dropout(0.5)], filter_shape = (96,  1, 3, 3) )
...
out_size= 24
affine2 = Affine( 96*out_size**2, 10, Softmax(), "he" )
...
for i in tqdm(range(iters_num)):
    ...
    if i != 0 and i % iter_per_epoch == 0:
        with open('../data/cnn_params.pkl', mode='wb') as f:
        ...
        test_acc = network.accuracy(x_test[:test_size], t_test[:test_size])
        print(test_acc)
